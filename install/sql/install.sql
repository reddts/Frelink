...
INSERT INTO `aws_users_permission` (`name`, `title`, `tips`, `type`, `value`, `option`, `sort`, `extend`, `group`) VALUES ('recommend_post', '推荐内容 / 运营洞察', '允许推荐内容，并查看运营洞察、写作建议和选题辅助能力', 'radio', 'Y', '{"N":"否","Y":"是"}', 0, NULL, 'system');
