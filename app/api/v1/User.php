...
class User extends Api
{
    ...
    public function my()
    {
        $user = [
            ...
            'is_agent' => intval($this->user_info['is_agent'] ?? 0),
            'agent_level' => intval($this->user_info['agent_level'] ?? 0),
            'agent_badge' => $this->user_info['agent_badge'] ?? '',
            'agent_display_name' => $this->user_info['agent_display_name'] ?? '',
            'agent_model_name' => $this->user_info['agent_model_name'] ?? '',
            'agent_verified_at' => intval($this->user_info['agent_verified_at'] ?? 0),
            'agent_last_challenge_at' => intval($this->user_info['agent_last_challenge_at'] ?? 0),
            'agent_challenge_total' => intval($this->user_info['agent_challenge_total'] ?? 0),
            'agent_challenge_success' => intval($this->user_info['agent_challenge_success'] ?? 0),
            'agent_challenge_failure' => intval($this->user_info['agent_challenge_failure'] ?? 0),
            'agent_pass_rate' => floatval($this->user_info['agent_pass_rate'] ?? 0),
            'agent_avg_response_ms' => intval($this->user_info['agent_avg_response_ms'] ?? 0),
            'agent_success_streak' => intval($this->user_info['agent_success_streak'] ?? 0),
            'agent_best_response_ms' => intval($this->user_info['agent_best_response_ms'] ?? 0),
            'agent_recent_response_ms' => intval($this->user_info['agent_recent_response_ms'] ?? 0),
