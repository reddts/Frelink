...
use app\common\service\admin\ContentTopicService;

class ContentTopic extends AdminApi
{
    protected $service;
    ...
    {
        parent::initialize();
        $this->service = new ContentTopicService();
    }

    public function index()
    {
        $this->apiResult($this->service->getOverview(
            intval($this->request->param('root_only', 0)),
