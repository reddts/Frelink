<ul class="nav nav-tabs nav-tabs-block" id="builder-form-link-group-tab">
    {volist name="form.tabs" id="item" key="items_key"}
    <li class="nav-item">
        <a class="nav-link {if $item.active==1}active{/if}" data-pjax="wrapMain" href="{$item.link}">{:L($item.title)}</a>
    </li>
    {/volist}
</ul>
<div class="tab-content p-3">
    <div class="tab-pane active">
    {volist name="form.configs" id="form_group"}
