...
abstract class AdminApi extends Base
{
    ...
    protected function buildPermissionPath(): string
    {
        ...
        $mapped = [
            ...
            'contentcolumn/index' => 'content/Column/index',
            'contentcolumn/detail' => 'content/Column/edit',
            'contentcolumn/save' => 'content/Column/edit',
            'contentcolumn/delete' => 'content/Column/delete',
            'contentcolumn/approve' => 'content/Column/approval',
            'contentcolumn/decline' => 'content/Column/decline',
