...
class CaptchaHelper
{
	...
	public function creat(){
		...
		$imagePath = public_path('static').'libs/captcha/'.$imagePathArr[rand(0, count($imagePathArr) - 1)];
		$fontPath = public_path('static').'libs/captcha/font/SourceHanSansCN-Normal.ttf';
		...
		$_SESSION['captcha_text'] = $textArr;
		setcookie('captcha_text', implode(',', $text), time() + 3600, '/');
		//生成图片
		switch($imageType){
			case 1://GIF
