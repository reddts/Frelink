...
<head>
    ...
    <style>
        * {-moz-box-sizing:border-box;-webkit-box-sizing:border-box;box-sizing:border-box;}
        ...
        .error-page-wrapper .content-container {border-radius:2px;text-align:center;box-shadow:1px 1px 1px rgba(99,99,99,0.1);padding:50px;background-color:#fff;width:100%;max-width:560px;position:absolute;left:50%;top:40%;margin-top:-220px;margin-left:-280px;}
...
<div class="content-container">
    <div class="head-line">
        <img src="/static/common/image/error.svg" alt="" width="150" />
    </div>
    <div class="subheader">
        <span class="info">
            <?=$debug?$message:$lang['The page you are looking for is temporarily unavailable']?>
        </span>
        <span class="bug" style="display: none">
            <?=$message?>
        </span>
    </div>
    <div class="hr"></div>
    <div class="context">
        <p>
            ...
            <br>
            <span onclick="$('.subheader .bug').toggle();$('.subheader .info').toggle();" style="cursor: pointer;color: #2ecc71">查看错误信息</>
        </p>
    </div>
    <div class="buttons-container">
        <a href="/"><?=$lang['Home']?></a>
        <a onclick="reportBug()" href="javascript:;"><?=$lang['Feedback']?></a>
    </div>
</div>
<script>
    function reportBug()
    {
        $.ajax({
            ...
            success: function (ret) {
                layer.msg('BUG反馈成功,给您带来的不便敬请谅解!',{},function (){
