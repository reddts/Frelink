...
<div class="main-container mt-1 mescroll" id="ajaxPage">
    ...
    <div class="bg-white px-3 py-2 mb-2">
        <div class="d-flex justify-content-between align-items-center mb-2">
            ...
            <a href="{:get_url('help/index')}" class="text-primary font-9" data-pjax="pageMain">{:L('查看知识地图')}</a>
        </div>
        {if !empty($archive_chapters)}
        {foreach $archive_chapters as $chapter}
        <a href="{:get_url('help/detail',['token'=>$chapter['url_token']])}" class="d-block border rounded px-3 py-2 text-dark mb-2" data-pjax="pageMain">
        ...
        <div class="text-muted py-2">
            ...
            <a href="{:get_url('help/index')}" class="btn btn-sm btn-light" data-pjax="pageMain">{:L('前往知识地图')}</a>
        </div>
        {/if}
    </div>
